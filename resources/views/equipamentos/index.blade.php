...
<body class="overflow-hidden">
    <div class="container mx-auto p-4 lg:pl-[300px] mt-10 lg:mt-7 lg:max-w-6xl">
        ...
        <div class="flex items-center justify-center space-x-4">
            <i class="text-3xl bi bi-tools text-gray-200"></i>
            <h1 class="text-3xl font-bold text-gray-200">Equipamentos</h1>
        </div>
                    ...
                    <table class="table table-striped text-sm lg:text-lg rounded-lg overflow-hidden">
                        ...
                        <tbody class="divide-y divide-bdinput">
                            ...
                            <tr class="hover:bg-gray-700">
                                <td class="text-gray-200 text-center px-4 py-2">{{ $equipamento->nome }}</td>
                                <td class="text-gray-200 text-center px-4 py-2">{{ $equipamento->tipo }}</td>
                                
                                @can('acoes-gerente')
                                <td class="px-1 py-2">
                                    <a href="{{ route('equipamentos.edit', $equipamento) }}" class="bg-edit/10 border border-edit text-edit px-3 py-1 rounded-md shadow-lg text-sm font-bold
