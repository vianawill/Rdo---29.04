...
<div class="container mx-auto p-4 lg:pl-[300px] mt-6 lg:mt-20 lg:max-w-6xl">
        ...
        <h1 class="text-xl lg:text-6xl font-bold text-center text-gray-200">Olá,
            <span class="text-xl lg:text-6xl font-bold text-txtblue">{{ Auth::user()->name }}!</span>
        </h1>
        ...
        <div class="grid grid-cols-1 gap-7 mt-7 px-3 lg:px-0 w-full mx-auto">
            ...
            <div class="bg-input shadow-blue-custom p-4 rounded-lg w-full h-[250px] lg:max-w-3xl mx-auto">
                <h2 class="text-orange-400 text-lg lg:text-xl font-bold mb-2">
                    <i class="text-orange-400 text-lg lg:text-xl bi bi-file-earmark-text-fill"></i> RDOs Pendentes
                </h2>
                <ul class="space-y-2">
                ...
                <td class=" text-gray-200 text-center px-4 py-2 hidden lg:table-cell">{{ $rdo->numero_rdo }}</td>
                                ...
                                <td class="text-gray-200 text-center px-4 py-2">{{ $rdo->obras->nome }}</td>
                                <td class="text-gray-200 text-center px-4 py-2 hidden lg:table-cell">{{ $rdo->obras->empresa_contratada }}</td>
                                <td class="text-gray-200 text-center px-4 py-2">{{ $rdo->obras->objeto_contrato }}</td>
        ...
        <!-- Botão fixo -->
        <div class="fixed bottom-1 pb-4 mt-1 lg:bottom-10 left-1/2 transform -translate-x-1/2 lg:left-[calc(298px+40%)] lg:-translate-x-1/2 flex justify-center">
            <a href="/rdos/create" class="w-[80px] h-[55px] bg-txtblue text-white px-4 py-2 rounded-full shadow-lg text-md font-bold flex items-center justify-center space-x-1 overflow-hidden transition-all duration-200">
