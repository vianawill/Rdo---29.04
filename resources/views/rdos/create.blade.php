                ...
                <form class="flex flex-col" method="POST" action="{{ route('rdos.store') }}">
                    ...
                    <div class="form-group row mb-6 pt-3 rounded bg-input">
                        ...
                        <button type="button" class="block btn btn-sm btn-primary text-md mx-auto
                            bg-txtblue/10 border border-txtblue text-txtblue font-bold mt-4 py-1 px-2 rounded-lg shadow-lg hover:shadow-xl trasition 
                       hover:bg-txtblue hover:text-white" onclick="adicionarTurno()">
                            + Adicionar Turno
                        </button>
                    </div>
                    ...
                    <button class="btn btn-primary
                            bg-accept/10 border border-accept text-accept px-4 py-2 rounded-lg shadow-lg text-md font-bold whitespace-nowrap
