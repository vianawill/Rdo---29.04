                    ...
                    <ul class="overflow-y-auto pr-2 -mr-2 scrollbar-hide max-h-[72vh] sm:max-h-[74vh] space-y-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="flex flex-wrap justify-between -mx-2 sm:px-20 px-5 p-4">
                                <div class="col-md-4">
                                    <strong class=" text-txtblue">Manhã:</strong>
                                    <p class="text-gray-200">{{ $rdo->manha }}</p>
                                </div>
                                <div class="col-md-4">
                            ...
                            <h6 class="text-center font-semibold text-txtblue bg-bdinput rounded-md">Área</h6>
                            ...
                            <h6 class="text-center font-bold text-txtblue bg-bdinput rounded-md">Equipamentos Utilizados</h6>

                            <div class="flex flex-wrap justify-between -mx-2 sm:px-15 px-5 p-4">
                                <div class="text-gray-200 col-md-6">
                                    @if($rdo_equipamento->isNotEmpty())
                                    <ul>
                            ...
                            <h6 class="text-center font-bold text-txtblue bg-bdinput rounded-md">Mão de Obra Direta Utilizada</h6>
                            ...
                            <div class="row flex flex-wrap justify-between -mx-2 sm:px-15 px-5 p-3">
                                <div class="text-gray-200 col-md-6">
                                    ...
                                    <ul>
                                        ...
                                        <li class="mb-6">
                                            <div class="font-semibold text-gray-200">{{ $mao_obra->funcao }}</div>
                                            <div class="flex mt-4">
                                                <div class="mr-6">
                                                    <label class="block text-sm text-txtblue font-bold mb-2">Manhã</label>
                            ...
                            <h6 class="text-center font-bold text-txtblue bg-bdinput rounded-md">Mão de Obra Indireta Utilizada</h6>
